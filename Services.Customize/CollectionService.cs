...
namespace Services.Customize
{
    ...
    public class CollectionService : ICollectionService
    {
        ...
        public CollectionViewModel Create(CollectionViewModel vmCollection, string UserName)
        {
            ...
            int OtherCollection = Constants.DocumentTypeIdConstants.OtherCollection;
        ...
        public void Submit(int Id, string UserName, string GenGatePass, string UserRemark)
        {
            ...
            int DocumentTypeId = _DocumentTypeService.Find(Constants.DocumentTypeIdConstants.Collection).DocumentTypeId;
            ...
            if (DocumentTypeId == vmCollection.DocTypeId)
            {
                ...
                _unitOfWork.SqlQuery<Dimension1RecipeViewModel>("" + ConfigurationManager.AppSettings["DataBaseSchema"] + ".sp_CollectionAdjustment @PersonId", SqlParameterPersonId).ToList();
            }
