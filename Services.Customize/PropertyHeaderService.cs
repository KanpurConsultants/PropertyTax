...
namespace Services.Customize
{
    public interface IPropertyHeaderService : IDisposable
    {
        ...
        IQueryable<PropertyHeaderViewModel> GetPropertyHeaderListPendingToSubmit(int DocumentTypeId, string Uname);
        IQueryable<PropertyHeaderViewModel> GetPropertyHeaderListPendingToReview(int DocumentTypeId, string Uname);
    ...
    public class PropertyHeaderService : IPropertyHeaderService
    {
        ...
        public IQueryable<PropertyHeaderViewModel> GetPropertyHeaderListPendingToSubmit(int id, string Uname)
        {

            List<string> UserRoles = (List<string>)System.Web.HttpContext.Current.Session["Roles"];
            var Person = GetPropertyHeaderList(id, Uname).AsQueryable();
        ...
        public IQueryable<PropertyHeaderViewModel> GetPropertyHeaderListPendingToReview(int id, string Uname)
        {
        ...
        public void Submit(int Id, string UserName, string GenGatePass, string UserRemark)
        {
            ...
            if (vmPropertyHeader != null)
            {
                ...
                _unitOfWork.SqlQuery<Dimension1RecipeViewModel>("" + ConfigurationManager.AppSettings["DataBaseSchema"] + ".sp_CalculatePropertyTax @PersonId", SqlParameterPersonId).ToList();
            }
            ...
            if (temp == null)
            {
                ...
                SqlParameter SqlParameterPersonId = new SqlParameter("@PersonId", vmPropertyHeader.PersonID);
                _unitOfWork.SqlQuery<Dimension1RecipeViewModel>("" + ConfigurationManager.AppSettings["DataBaseSchema"] + ".sp_PropertyTaxDue     @Site, @Division,	@IsFromWEFDate,@UserName,@BusinessSessionId, @PersonId", SqlParameterSite, SqlParameterDivision, SqlParameterIsFromWEFDate, SqlParameterUserName, SqlParameterBusinessSessionId, SqlParameterPersonId).ToList();
            }
        ...
        public ComboBoxPagedResult GetProperty(string searchTerm, int pageSize, int pageNum)
        {
            ...
            var list = (from P in _PropertyRepository.Instance
                        ...
                        from BusinessEntityTab in BusinessEntityTable.DefaultIfEmpty()
                        where P.DocTypeId == Constants.DocumentTypeIdConstants.Property
