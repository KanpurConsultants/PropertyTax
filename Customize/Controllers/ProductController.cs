...
namespace Customize.Controllers
{
    ...
    public class ProductController : System.Web.Mvc.Controller
    {
        ...
        {
            IQueryable<Product> Product = _ProductService.GetProductForIndex();
            return View(Product);
        }
        ...
        public ActionResult Create()//DocumentTypeId
        {
            ...
            vm.DocTypeId = Constants.DocumentTypeIdConstants.Product;
            vm.IsActive = true;
            ViewBag.Mode = "Add";
        ...
        public ActionResult Post(Product vm)
        {
            ...
            if (ModelState.IsValid)
            {
                if (vm.ProductId <= 0)
                {
                    ...
                    pt.ProductGroupId = Constants.ProductGroupConstants.ConstructionType;
                    pt.IsActive = true;
                    ...
                    {
                        DocTypeId = Constants.DocumentTypeIdConstants.Product,
                        DocId = pt.ProductId,
        ...
        {
            DocumentType Dt = _DocumentTypeService.Find(Constants.DocumentTypeIdConstants.Product);
