...
namespace Customize.Controllers
{
    ...
    public class SiteController : System.Web.Mvc.Controller
    {
        ...
        {
            Site vm = new Site();
            vm.DocTypeId = Constants.DocumentTypeIdConstants.Site;
            vm.IsActive = true;
            ViewBag.Mode = "Add";
        ...
        public ActionResult Post(Site vm)
        {
            ...
            if (ModelState.IsValid)
            {
                if (vm.SiteId <= 0)
                {
                    ...
                    {
                        DocTypeId = Constants.DocumentTypeIdConstants.Site,
                        DocId = pt.SiteId,
        ...
        {
            DocumentType Dt = _DocumentTypeService.Find(Constants.DocumentTypeIdConstants.Site);
