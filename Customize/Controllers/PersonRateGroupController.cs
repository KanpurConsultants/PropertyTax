...
namespace Customize.Controllers
{
    ...
    public class PersonRateGroupController : System.Web.Mvc.Controller
    {
        ...
        public ActionResult Index(string IndexType)
        {
            ...
            IQueryable<PersonRateGroup> PersonRateGroup = _PersonRateGroupService.GetPersonRateGroupListForIndex(SiteId);
        ...
        {
            DocumentType Dt = _DocumentTypeService.Find(Constants.DocumentTypeIdConstants.PersonRateGroup);
