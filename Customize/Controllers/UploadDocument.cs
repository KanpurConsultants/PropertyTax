...
namespace Web
{
    public class UploadDocument
    {
        ...
        public void UploadFile(int FileKey, Dictionary<string, string> versions, string FilePrefix, Constants.FileTypeConstants FType, out string FolderName, out string FileName)
        {
            ...
            if (FType == Constants.FileTypeConstants.Image)
            {
            ...
            else if (FType == Constants.FileTypeConstants.Other)
            {
